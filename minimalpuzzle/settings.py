...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sharedlibrary.utils.context_processors.django_puzzle_application_name',
                'sharedlibrary.utils.context_processors.back_link_referer',
                'sharedlibrary.utils.context_processors.installed_django_application_list',
                'sharedlibrary.utils.context_processors.global_application_context_parameters_configuration',
